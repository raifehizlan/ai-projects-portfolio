...
function Experience() {
  ...
  return (
    <div className="experience" id="experience">
      ...
      <div id="academic" className={`timeline ${activeTab === 'academic' ? 'active' : ''}`}>
        <div className="event">
          <h3>Master in Artificial Intelligence and Innovation Technology</h3> {/* Akademik deneyiminizi güncelleyin */}
          <p>MIA Digital University, Spain & Udima University, Spain, Online</p>
        </div>
        <div className="event">
          <h3>Bachelor in System Engineering – Graduation Grade: 3.74/4</h3> {/* Akademik deneyiminizi güncelleyin */}
          <p>Military Academy, Ankara, Turkey</p>
        </div>
      </div>

      <div id="professional" className={`timeline ${activeTab === 'professional' ? 'active' : ''}`}>
        <div className="event">
          <h3>Machine Learning Engineer</h3> {/* Profesyonel deneyiminizi güncelleyin */}
